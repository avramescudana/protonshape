...
function main(params_path::String)
    ...
    t_range, dσdt_coh, dσdt_coh_err, dσdt_incoh, dσdt_incoh_err = compute_cross_sections(params_path, Δ_range, Nsamples, params_run)
