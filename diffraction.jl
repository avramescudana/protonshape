...
function xp(t)
	# Weak dependence on t, typically extract at t=0
	nom = Mᵥ*Mᵥ + Q² - t
	den = W*W + Q² - mₚ*mₚ
	return nom/den
end
...
begin
	...
	# N = 200 # Normalization factor

	σtogev = 2.56819 # 1 mb = 2.56819 GeV−2
	σ₀ *= σtogev
end
...
function σqq̅(xₚ,r)
	term_exp = 1 - exp(- r * r * Qₛ(xₚ) * Qₛ(xₚ) / 4)
	return σ₀ * term_exp
end
...
git-tree-sha1 = "33a5cceb07ac41f8cc6c37a412d80b0fc33becac"
...
git-tree-sha1 = "38b40b62ddf559d5960bb1439f4f4a3529593e82"
...
git-tree-sha1 = "953cc9366413bc15555738275d2dd49277417719"
...
deps = ["DataDrivenDiffEq", "DataDrivenSparse", "DataStructures", "LinearAlgebra", "SpecialFunctions", "Statistics", "SymbolicUtils", "Symbolics", "TermInterface"]
git-tree-sha1 = "9346b473c77441c56f120ed1acf0ec9b5ab817fb"
...
git-tree-sha1 = "5435f35388d027b0b53b6e790b89639f3f555a84"
